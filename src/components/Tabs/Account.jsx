  ...
  return (
    <View>
      ...
      <View style={{ height: "90%", padding: 10, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        <TouchableOpacity activeOpacity={0.2} onPress={() => navigation.navigate('EditProfile')}>
          <View style={{ marginRight: 10, backgroundColor: 'white', padding: 10, borderRadius: 17, display: 'flex', flexDirection: 'row', gap: 8 }}>
            ...
            <View style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '70%' }}>
              ...
              <View>
                <Icon name='chevron-thin-right' size={20} color={Colors.sec} />
              </View>
            </View>
          </View>
        </TouchableOpacity>
              ...
              .map(key => {
                return (
                  <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                    <Text style={{ fontSize: 15, color: Colors.sec, fontFamily: 'Poppins-Regular', textTransform: 'capitalize' }}>{key}</Text>
        ...
        <View>
          <Text style={{ fontSize: 20, color: Colors.ter, fontFamily: 'Poppins-Medium', marginBottom: 10 }}>General</Text>
          <View style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={{ fontSize: 15, color: Colors.sec, fontFamily: 'Poppins-Regular', textTransform: 'capitalize' }}>Theme</Text>
              <Text style={{ fontSize: 15, color: 'black', fontFamily: 'Poppins-Medium' }}>Light</Text>
            </View>
          </View>
        </View>

        <TouchableOpacity onPress={() => setshowLogoutModal(true)} activeOpacity={0.6} style={{ marginBottom: 25, backgroundColor: Colors.pri, paddingVertical: 18, alignItems: 'center', justifyContent: 'center', borderRadius: 5 }}>
        ...
        <Modal
          ...
          <View style={styles.centeredView}>
            <View style={styles.modalView}>
              <Text style={{ color: Colors.ter, fontSize: 20, fontFamily: 'Poppins-Medium' }}>Log out</Text>
              <Text style={{ color: Colors.ter, fontSize: 15, marginVertical: 10 }}>Log out from Study Sphere?</Text>
              <View style={{ display: 'flex', flexDirection: 'row', gap: 30 }}>
                <TouchableOpacity onPress={() => setshowLogoutModal(!showLogoutModal)} >
                  <Text style={{ color: Colors.ter, fontSize: 15 }}>Cancel</Text>
                </TouchableOpacity>

                <TouchableOpacity onPress={logOut} >
                  <Text style={{ color: Colors.pri, fontSize: 15 }}>Log out</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
